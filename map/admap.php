                ...
                <ul id="components-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
                    <li>
                        <a href="#" id="senior-link" class="active">
                            <i class="bi bi-circle"></i><span><img src="assets/img/tanda.png" alt="amb" height="40"
                                    width="40"> Senior Citizen</span>
                        </a>
                    </li>
                    <li>
                        <a href="#" id="single-link" class="active">
                            <i class="bi bi-circle"></i><span><img src="assets/img/parent.png" alt="amb" height="40"
...
var locations = [
    [
        1,14.655975, 120.975315,'DASF','FDSAFD','Senior Citizen'
    ],
    [
        1,14.65555, 120.972805,'DASF','FDSAFD','Solo Parent'
    ],
    [
    ...
    success: function(data){
        ...
        for (var i = 0; i < locations.length; i++) {
            template = "<h4>" + locations[i][4] + "</h4><p>" + locations[i][5] +
                "</p><a style='text-decoration:none;'" + locations[i][0] +
                "' ></a>";
            ...
            if (locations[i][5] == 'Senior Citizen') {
                ...
                senior.push(marker); 
            } else if (locations[i][5] == 'Solo Parent') {
                const marker = new L.marker([locations[i][1], locations[i][2]], {
                    icon: two
                }).bindPopup(template).addTo(mymap);
                single.push(marker); 
